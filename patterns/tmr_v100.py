...
class TmrV100Definition(PatternDefinition):
    ...
    def __init__(self, comp_name: str, comp_n_inputs: int, modules_f_atoms: list, voter_f_atom: Symbol):
        ...
        super(TmrV100Definition, self).__init__(comp_name,  comp_n_inputs, modules_f_atoms + [voter_f_atom], PatternType.TMR_V100)
    ...
    def create(self, nominal_mod_beh) -> Pattern:
        return TmrV100(self._comp_name, self._comp_n_inputs, self._modules_f_atoms, self._voter_f_atom, nominal_mod_beh)
...
class TmrV100(Pattern):
    ...
    def __init__(self, comp_name: str, comp_n_inputs: int, modules_fault_atoms: list, voter_fault_atom: Symbol, nominal_mod_beh: Symbol):
        ...
        """
        pattern_name = comp_name + "." + PatternType.TMR_V100.name
        ...
        # Output port of the pattern corresponds to the output port of the voter , of Module 2 and Module 3
        output_ports = modules_out_ports
        output_ports[0] = self._voter.output_ports[0]
        assert len(output_ports) == 3, "[" + pattern_name + "] The pattern must have 3 outputs"
        super(TmrV100, self).__init__(pattern_name, PatternType.TMR_V100, modules_fault_atoms + [voter_fault_atom],
...
if __name__ == "__main__":
    ...
    tmr = TmrV100("C1", 1, [Symbol("F0"), Symbol("F1"), Symbol("F2")], Symbol("F3"), nominal_beh)
