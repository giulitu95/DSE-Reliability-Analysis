...
class TmrV122Definition(PatternDefinition):
    ...
    def __init__(self, comp_name: str, comp_n_inputs: int, modules_f_atoms: list, voters_f_atoms: list):
        ...
        super(TmrV122Definition, self).__init__(comp_name, comp_n_inputs, modules_f_atoms + voters_f_atoms, PatternType.TMR_V122)
        self._pt_name = pt_type.name

    def create(self, nominal_mod_beh) -> Pattern:
        return TmrV122(self._comp_name, self._comp_n_inputs, self._modules_f_atoms, self._voters_f_atoms, nominal_mod_beh)
...
class TmrV122(Pattern):
    ...
    def __init__(self, comp_name: str, comp_n_inputs: int, modules_fault_atoms: list, voters_fault_atoms: list, nominal_mod_beh: Symbol):
        ...
        """
        pattern_name = comp_name + "." + PatternType.TMR_V122.name
        ...
        # Output of the pattern corresponds to the output ports of the voters (V1, V2, V2)
        output_ports = []
        for voter in voters:
...
if __name__ == "__main__":
    pt122_def = TmrV122Definition("C1", 1, [Symbol("F_M0"), Symbol("F_M1"), Symbol("F_M2")], [Symbol("F_V0"), Symbol("F_V1")])
    pt = pt122_def.create(Symbol("beh", FunctionType(REAL, [REAL])))
